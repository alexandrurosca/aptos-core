...
module marketplace::marketplace_bid_utils {
    ...
    public fun buy_from_owner_with_fee<CoinType>(
        buyer: &signer,
        lister_address: address,
        listing_creation_number: u64,
    ...
    fun buy_from_listing_with_fee<CoinType>(
        buyer: &signer,
    ...
    fun initialize_bid_records<CoinType>(bidder: &signer)  {
    ...
    fun create_bid_id(bidder: address, listing_id: ID): BidId {
        BidId {
            bidder,
            listing_id,
        }
    ...
    fun get_bid_id_address(bid_id: &BidId): address {
        bid_id.bidder
    }

    /// get bidder listing id from BidId
    fun get_bid_id_listing_id(bid_id: &BidId): ID {
        bid_id.listing_id
    }
    ...
    public fun test_instant_sale_setup(
        ...
        start_sec: u64,
        end_sec: u64,
    ): (Listing<coin::FakeMoney>, aptos_token::token::TokenId) {
